...
EFC 提供 8 个阶段的全顾问服务,覆盖方案设计、扩初设计、施工图设计、招标配合、施工配合、竣工验收等全过程。我们的顾问团队由资深幕墙专家组成,覆盖结构、热工、声学、防水、防火等多个专业方向。服务内容包括方案评审、节点设计、计算分析、样板审核、招标技术文件编制、施工现场配合等。

## 报价与同行参考

合同总价 211 万元人民币,分 6 期支付,首付 30% 即 63.3 万元于合同生效后 7 个工作日内支付。后续各期按服务阶段完成情况支付。KPF 顾问同类项目报价约 240 万元,Permasteelisa 设计咨询约 280 万元,Front 工程咨询约 260 万元。EFC 报价比同行低约 10-20%,主要因为本地化运营,人力成本结构不同。如对报价有异议,可参考同行报价区间评估性价比。

## 关键时间节点

预计 2026 年 7 月完成扩初阶段交付,2026 年 12 月完成施工图设计交付。其中方案优化阶段 2 个月,扩初阶段 3 个月,施工图阶段 5 个月。各阶段交付物包括设计图纸、计算书、技术规格书。设计完成后进入招标配合阶段,预计 2027 年 3 月开始施工配合,2027 年 Q4 完成幕墙安装,2028 年初竣工验收。

## 风险条款与终止机制

如业主单方面终止合同,EFC 已完成阶段按工作量结算,不退已收款项。如因 EFC 原因延期超过 30 天,业主有权要求扣减下一期款项 5%。不可抗力情况下双方协商处理。所有争议提交上海仲裁委员会仲裁。本合同自双方签字盖章之日起生效。
"#;
